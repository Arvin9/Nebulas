...
public class QRUtil {
	public static String createQrcode(String _text){
		...
		try {
			...
			BitMatrix bitMatrix = new MultiFormatWriter().encode("hello", BarcodeFormat.QR_CODE, qrcodeWidth, qrcodeHeight, hints);
	...
	public static void main(String[] args) {
		...
		System.out.println(decodeQr("F:\\qrcode\\1753435370.png"));
	}
}
